...
class HbaseClient:
    def __init__(self, host="10.10.23.11", port=9090, timeout=120000, size=20, compat="0.98"):
        self.host = host
        self.port = port
    ...
    def scan(
        ...
        with self.conn() as conn:
            ...
            if filter:
                ...
                result = table.scan(limit=limit, columns=columns, row_start=row_start, row_stop=row_stop)
            return result
