...
try:
    ...
    raise ImportError(f"easybase 导入失败: {e}")


class HbaseThrift2Client:
    def __init__(self, host="10.10.23.11", port=9091, timeout=120000, size=20, compat="0.98"):
        self.host = host
        self.port = port
...
if __name__ == "__main__":
    hbase_thrift2_client = HbaseThrift2Client(host="10.193.51.96", port=21305, compat="2.2.0")
